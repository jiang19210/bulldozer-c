    ...
    try {
        ...
        if (err) {
            ...
            if (result.is_success && result.result == '0') {
                console.log('[数据影响行数为0][%s##%s][%s]', m, name, JSON.stringify(httpcontext));
            } else if (result.is_success) {
                console.log('[数据保存成功][%s##%s], result:%s', m, name, JSON.stringify(result.result));
            } else {
                if (m.indexOf('mysql.') != -1) {
                    delete result.result.sql;
                }
                console.error('[数据保存失败][%s##%s] %s, result:%s', m, name, result.taskid, JSON.stringify(result.result));
            }
        }
        if (callback) {
...
exports.findAndModify = function (collection, callback) {
    let options = httpUtils.serverOptions('/service/findAndModify');
    httpClientp.request(options, callback, {'request': {'postdata': collection}});
};

//保存或更改 批量
exports.saveOrUpdateAll = function (collection) {
    let options = httpUtils.serverOptions('/service/saveOrUpdateAll');
...
exports.saveOrUpdate = function (collection) {
    let options = httpUtils.serverOptions('/service/saveOrUpdate');
    httpClientp.request(options, function (err, body) {
        console.log('saveOrUpdate result [' + body + ']');
    }, {'request': {'postdata': collection}});
};
exports.remove = function (collection, callback) {
    let options = httpUtils.serverOptions('/service/remove');
    httpClientp.request(options, callback, {'request': {'postdata': collection}});
};
//查询
exports.find = function (collection, callback) {
    let options = httpUtils.serverOptions('/service/find');
    httpClientp.request(options, callback, {'request': {'postdata': collection}});
};
exports.findField = function (collection, callback) {
    let options = httpUtils.serverOptions('/service/findField');
    httpClientp.request(options, callback, {'request': {'postdata': collection}});
};
//保存
exports.save = function (collection) {
    let options = httpUtils.serverOptions('/service/save');
    httpClientp.request(options, function (err, body) {
...
exports.update = function (collection) {
    let options = httpUtils.serverOptions('/service/update');
    httpClientp.request(options, function (err, body) {
...
exports.dropCollection = function (collection) {
    let options = httpUtils.serverOptions('/service/dropCollection');
    httpClientp.request(options, function (err, body) {
...
exports.renameCollection = function (collection) {
    let options = httpUtils.serverOptions('/service/renameCollection');
    httpClientp.request(options, function (err, body) {
...
exports.lpushs = function (collection, callback) {
    let options = serverOptions('/service/lpushs');
...
exports.renamenx = function (collection, callback) {
    let options = serverOptions('/service/renamenx');
    httpClientp.request(options, function (err, body, res, httpcontext) {
...
exports.mysql_save = function (collection, callback) {
    let options = serverOptions('/service/mysql_save');
    httpClientp.request(options, function (err, body, res, httpcontext) {
        handlerResult(err, body, callback, res, httpcontext, 'mysql.mysql_save');
    }, {'request': {'postdata': collection}});
};
exports.mysql_update = function (collection, callback) {
    let options = serverOptions('/service/mysql_update');
    httpClientp.request(options, function (err, body, res, httpcontext) {
        handlerResult(err, body, callback, res, httpcontext, 'mysql.mysql_update');
    }, {'request': {'postdata': collection}});
};
exports.mysql_save_one = function (collection, callback) {
    let options = serverOptions('/service/mysql_save_one');
    httpClientp.request(options, function (err, body, res, httpcontext) {
        handlerResult(err, body, callback, res, httpcontext, 'mysql.mysql_save_one');
    }, {'request': {'postdata': collection}});
};
exports.mysql_save_or_update = function (collection, callback) {
    let options = serverOptions('/service/mysql_save_or_update');
    httpClientp.request(options, function (err, body, res, httpcontext) {
        handlerResult(err, body, callback, res, httpcontext, 'mysql.mysql_save_or_update');
    }, {'request': {'postdata': collection}});
};
exports.mysql_select = function (collection, callback) {
    let options = serverOptions('/service/mysql_select');
    httpClientp.request(options, function (err, body, res, httpcontext) {
